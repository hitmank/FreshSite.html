   ...
   */
   function showImageForPage(pageNumber){
    if (pageNumber == 0){
      $('#divimg1').css('display','inline')
      $('#divimg1').css('width','48%')
      $('#divimg2').css('display','inline')



$('#img1').css('height','auto')
        $('#img1').css('width','100%')
      $('#img1').attr('src','img/spacegame.jpg')
      $('#img2').attr('src','img/spacegame2.jpg')
    }
    else if(pageNumber == 1){
      $('#divimg1').css('width','80%')
      $('#divimg2').css('display','none')
      $('#img1').attr('src','img/sap2.png')
        $('#img1').css('height','85%')
        $('#img1').css('width','auto')

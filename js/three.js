...
function init() {
  ...
  root.renderer.setClearColor(0xced5cf);
...
function createTextAnimation() {
  var geometry = generateTextGeometry('Karan Balakrishnan', {
    size:14,
    height:0,
    font:'droid sans',
    weight:'bold',
...
function TextAnimation(textGeometry) {
  ...
  var length = new THREE.Vector3(size.width/2, size.height/2, size.depth).multiplyScalar(0.5).length();
